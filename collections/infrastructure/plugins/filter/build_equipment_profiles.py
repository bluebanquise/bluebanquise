...
class FilterModule(object):
    def filters(self):
        return {
            'build_equipment_profiles': self.build_equipment_profiles
        }

    def build_equipment_profiles(self, hostvars, hosts_list, groups, hw_prefix='hw', os_prefix='os'):
        ...
        try:
            ...
            raise AnsibleFilterError(f"Critical failure in build_equipment_profiles filter: {str(e)}")