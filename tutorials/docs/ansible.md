...
a full manual tutorial is available on this site too.
...
packages manager or use a python venv to avoid conflicting with system python modules.
...
.. code-block:: bash
  ...
  mkdir $HOME/ansible/inventory/group_vars/slaves

Then, create file $HOME/ansible/inventory/group_vars/slaves/myship.yml with the
following content:
