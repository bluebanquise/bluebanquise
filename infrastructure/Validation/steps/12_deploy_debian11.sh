...
tar xvzf netboot.tar.gz
sudo cp debian-installer/amd64/initrd.gz /var/www/html/pxe/netboots/debian/11/x86_64/iso/
sudo cp debian-installer/amd64/linux /var/www/html/pxe/netboots/debian/11/x86_64/iso/
