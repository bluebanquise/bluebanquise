...
# Check if we wante a new inventory
if passed_arguments.create_inventory:
    ...
    menu_message = """
    Now lets create the first logical network.
    This network will be the core administration network of your cluster.
    Please give me a name for it. Note that I will then prepend it with 'net-'
    ...
    By default, I propose subnet to be 10.10.0.0 and prefix to be 16.
